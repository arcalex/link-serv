...
public class JSONHandler {
    ...
    public String getVersionCountsYearly(String url) {
    ...
    public String getVersionCountsMonthly(String url, int year) {

        ArrayList<HistogramEntry> histogramEntries = neo4jHandler.getVersionCountMonthly(url, year);
        return convertHistogramArrayToJson(histogramEntries);
    }

    public String getVersionCountsDaily(String url, int year, int month) {
    ...
    private ArrayList<String> runGetGraphResults(ArrayList<Node> rootNodes, int depth) {
        ...
        for (Node rootNode : rootNodes) {
            ...
            getGraphResultsHashSet.add(rootNode);
    ...
    private ArrayList<String> getOutlinkNodes(ArrayList<String> nodesNames, String nodeVersion) {
        ...
        for (String nodeName : nodesNames) {
            ...
            for (Object nodeMap : outlinkData) {
                getGraphResultsHashSet.add(nodeMap);
    ...
    private ArrayList<String> convertObjectStringToJSONString(HashSet<Object> graphResults) {
        HashSet<String> nodesHashSet = new HashSet<>();
        HashSet<String> edgesHashSet = new HashSet<>();

        for (Object graphObject : graphResults) {
            if (graphObject.getClass() == Node.class) {
