...
public class LinkServService {
    ...
    public String updateGraph(String jsonGraph, String workspaceName, String sessionId) {
        ...
        done = neo4jHandler.addNodesAndRelationships(jsonHandler.getGraphNodes(), jsonHandler.getGraphEdges(), sessionId);
        if (done) {
